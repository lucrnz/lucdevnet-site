...
> 🔧 You can access the source code for everything in this article [in this repository](https://github.com/lucrnz/observer-pattern-js).
...
> 💡 If you are unfamiliar with the [Record type](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type), it allows you to define key-value pairs where the key is a `string` and the value can be of any type, thanks to the `unknown` type.
