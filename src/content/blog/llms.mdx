...
## Disclaimer
I am not an expert on this topic; I merely know the basics of it. However, I have some information that I think can be useful for you to understand how it works and not see it as an *all-knowing computer that is plotting to rule the world*.
