...
<CodeSnippet language="html" name="index.html">
```html
<!doctype html>
<html lang="en">
  <head>
...
<CodeSnippet language="scss" name="style.scss">
```scss
$border-radius: 8px;
...
<CodeSnippet language="sh" name="build.sh">
```bash
mkdir -p dist && \
...
<CodeSnippet language="misc" name=".gitignore">
```
# Ignore dist folder
dist/
...
<CodeSnippet language="yaml" name="build.yml">
```yaml
