...
export function Footer() {
  return (
    <footer class="flex flex-col gap-2 max-w-fit text-sm">
      <div class="flex flex-col md:flex-row items-center gap-2">
        <div class="flex flex-row items-center gap-2" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="19" viewBox="0 0 496 512">
            <path
              fill="currentColor"
        ...
        >
          {`©${new Date().getFullYear()} lucdev.net. Some rights reserved. Content licensed under CC BY-NC-SA 4.0.`}
        </a>
      </div>
      <p class="italic">Opinions are my own and do not represent any current or former employer.</p>
    </footer>
  );
}
